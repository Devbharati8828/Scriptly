...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen flex selection:bg-blue-200">
      ...
      <div className="hidden lg:flex flex-1 relative bg-gradient-to-br from-[#0a2e6c] via-[#0d3b8f] to-[#1e40af] overflow-hidden items-center justify-center p-12">
        {/* Decorative background elements */}
        <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[radial-gradient(circle_at_30%_30%,_white_0%,_transparent_60%)]" />
        ...
        <div className="relative z-10 text-white max-w-lg text-center">
          <div className="inline-flex items-center justify-center w-20 h-20 rounded-3xl bg-white/10 backdrop-blur-md border border-white/20 mb-8 shadow-2xl">
            <Pill className="w-10 h-10 text-cyan-300" />
          </div>
