  ...
  return (
    <div className="p-8 pb-16 max-w-7xl mx-auto w-full">
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  ...
                  <select
                    ...
                    className="w-full h-9 rounded-md border border-input bg-background px-3 py-1 text-sm shadow-sm bg-slate-50 border-slate-200 focus:bg-white"
                  >
      ...
      <motion.div 
        ...
        className="bg-gradient-to-r from-indigo-500 via-purple-500 to-fuchsia-500 rounded-2xl p-6 text-white mb-8 shadow-lg shadow-purple-900/20 flex flex-col md:flex-row items-center justify-between gap-6 overflow-hidden relative"
      >
          ...
          <motion.div key={member.id} variants={itemVariants} className="glass-card rounded-2xl p-6 relative overflow-hidden group">
            ...
            <div className="flex justify-between items-start mb-6">
              <div className="flex items-center gap-4">
                <div className="w-14 h-14 rounded-full bg-gradient-to-br from-blue-400 to-indigo-600 flex items-center justify-center text-lg font-bold text-white shadow-md shadow-blue-500/30 ring-4 ring-white">
