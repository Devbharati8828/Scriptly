...
import { ShieldCheck, ArrowRight, FileText, UploadCloud, PhoneCall, Clock, CheckCircle2, AlertCircle } from 'lucide-react';
...
export default function PriorAuthPage() {
  ...
  const renderAuthsList = (auths: typeof priorAuths) => {
    if (auths.length === 0) {
      return (
  ...
  return (
    <div className="p-8 pb-16 max-w-5xl mx-auto w-full">
      ...
      <motion.div 
        ...
        animate={{ opacity: 1, y: 0 }}
        className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-2xl p-6 text-white mb-8 shadow-lg shadow-blue-900/20 flex flex-col md:flex-row items-center justify-between gap-6"
      >
        <div className="flex items-start gap-4">
      ...
      <Tabs defaultValue="all" className="w-full">
        ...
        <TabsContent value="pending" className="space-y-6">
          {renderAuthsList(priorAuths.filter(pa => pa.status === 'pending' || pa.status === 'under-review'))}
        </TabsContent>
