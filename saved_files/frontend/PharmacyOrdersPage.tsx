...
import { Package, Truck, Store, MapPin, Phone, ArrowRight, Clock, CheckCircle2 } from 'lucide-react';
...
export default function PharmacyOrdersPage() {
  ...
  const renderOrdersList = (orders: typeof pharmacyOrders) => {
    if (orders.length === 0) {
      return (
    ...
    <div className="p-8 pb-16 max-w-5xl mx-auto w-full">
      ...
      <Tabs defaultValue="active" className="w-full">
        ...
        <TabsContent value="active" className="space-y-8">
          {renderOrdersList(pharmacyOrders.filter(o => o.status !== 'completed' && o.status !== 'delivered' && o.status !== 'picked-up'))}
        </TabsContent>
