...
export default function Sidebar() {
  ...
  return (
    <motion.aside
      ...
      className="fixed left-0 top-0 bottom-0 w-[260px] bg-gradient-to-b from-[#0a2e6c] to-[#0d3b8f] text-white flex flex-col z-50 shadow-2xl"
    >
      {/* Logo */}
      <div className="px-6 py-5 flex items-center gap-3">
        <div className="w-10 h-10 rounded-xl bg-gradient-to-br from-cyan-400 to-blue-500 flex items-center justify-center shadow-lg shadow-blue-500/30">
      ...
      <div className="px-3 pb-2">
        ...
        <div className="space-y-1">
          {careTeam.map((member) => (
            ...
            >
              <div className="w-8 h-8 rounded-full bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center text-xs font-bold text-white ring-2 ring-white/20">
