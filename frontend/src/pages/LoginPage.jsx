...
import { CapsuleLogoIcon, AutoRefillsIcon } from '@/components/icons/CustomIcons';
  ...
  return (
    <div className="min-h-screen flex selection:bg-blue-200">
      ...
      <div className="hidden lg:flex flex-1 relative bg-linear-to-br from-[#0a2e6c] via-[#0d3b8f] to-[#1e40af] overflow-hidden items-center justify-center p-12">
        <div className="absolute top-0 left-0 w-full h-full opacity-10 bg-[radial-gradient(circle_at_30%_30%,white_0%,transparent_60%)]" />
        <div className="absolute -bottom-32 -left-32 w-96 h-96 bg-blue-500 rounded-full blur-[100px] opacity-40" />
        <div className="absolute top-20 right-20 w-64 h-64 bg-cyan-400 rounded-full blur-[100px] opacity-20" />
        
        <motion.div 
          animate={{ y: [-10, 10, -10] }} 
          transition={{ duration: 6, repeat: Infinity, ease: "easeInOut" }}
          className="absolute top-16 left-16 backdrop-blur-md p-4 rounded-2xl bg-white/10 border border-white/20 shadow-2xl"
        >
          <div className="flex items-center gap-3 text-white">
             <AutoRefillsIcon className="w-10 h-10 drop-shadow-md" />
             <div>
               <p className="text-sm font-bold">Refill Scheduled</p>
               <p className="text-xs text-blue-200">Atorvastatin 20mg</p>
             </div>
          </div>
        </motion.div>
        ...
        <div className="relative z-10 text-white max-w-lg text-center">
          ...
          <h1 className="text-4xl font-black mb-4 tracking-tight">Scriptly</h1>
          <p className="text-xl text-blue-100 font-medium leading-relaxed">
            Your chronic medication management, simplified and automated.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 bg-slate-50 relative">
        ...
        >
          <div className="text-center mb-8">
            ...
            <p className="text-slate-500">Sign in to manage your medications</p>
            <div className="mt-3 px-4 py-2 bg-blue-50/70 border border-blue-100/50 rounded-xl text-xs text-blue-700 font-medium">
              Demo Account: <span className="font-bold text-blue-800">john@example.com</span> / <span className="font-bold text-blue-800">password</span>
            </div>
          </div>
          ...
          <form onSubmit={handleLogin} className="space-y-5">
            ...
            <div className="space-y-2">
              <div className="flex justify-between items-center">
                ...
                <Link to="#" className="text-sm font-semibold text-blue-600 hover:text-blue-700">Forgot password?</Link>
              </div>
              <div className="relative">
          ...
          <p className="mt-8 text-center text-slate-500 font-medium">
            ...
            <Link to="/signup" className="text-blue-600 font-bold hover:text-blue-700">Sign up</Link>
          </p>
        </motion.div>
      </div>
    </div>
