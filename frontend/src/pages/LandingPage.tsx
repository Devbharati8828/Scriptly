        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <motion.div whileHover={{ y: -8 }} className="glass-card bg-white p-8 rounded-3xl transition-all">
              <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-blue-100 to-cyan-100 flex items-center justify-center mb-6">
            ...
            <motion.div whileHover={{ y: -8 }} className="glass-card bg-white p-8 rounded-3xl transition-all">
              <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-purple-100 to-pink-100 flex items-center justify-center mb-6">
            ...
            <motion.div whileHover={{ y: -8 }} className="glass-card bg-white p-8 rounded-3xl transition-all">
              <div className="w-14 h-14 rounded-2xl bg-linear-to-br from-amber-100 to-orange-100 flex items-center justify-center mb-6">
      ...
      <section id="how-it-works" className="py-24 bg-white">
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <motion.div whileHover={{ y: -8 }} className="text-center transition-all">
              <div className="w-16 h-16 rounded-2xl bg-blue-100 flex items-center justify-center mx-auto mb-6 text-blue-600 font-bold text-2xl">1</div>
              <h3 className="text-xl font-bold text-slate-800 mb-3">Sign Up</h3>
              <p className="text-slate-600">Create an account and connect your insurance securely.</p>
            </motion.div>
            <motion.div whileHover={{ y: -8 }} className="text-center transition-all">
              <div className="w-16 h-16 rounded-2xl bg-blue-100 flex items-center justify-center mx-auto mb-6 text-blue-600 font-bold text-2xl">2</div>
              <h3 className="text-xl font-bold text-slate-800 mb-3">Transfer Meds</h3>
              <p className="text-slate-600">We automatically import and manage your current prescriptions.</p>
            </motion.div>
            <motion.div whileHover={{ y: -8 }} className="text-center transition-all">
              <div className="w-16 h-16 rounded-2xl bg-blue-100 flex items-center justify-center mx-auto mb-6 text-blue-600 font-bold text-2xl">3</div>
              <h3 className="text-xl font-bold text-slate-800 mb-3">Relax</h3>
              <p className="text-slate-600">We handle refills, prior auths, and delivery coordination.</p>
            </motion.div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <motion.div whileHover={{ y: -8 }} className="glass-card bg-white p-8 rounded-3xl transition-all">
              ...
              <p className="text-slate-600 italic">"Scriptly has completely changed how I manage my monthly refills. I no longer have to call the pharmacy or my doctor. It just works!"</p>
            </motion.div>
            <motion.div whileHover={{ y: -8 }} className="glass-card bg-white p-8 rounded-3xl transition-all">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-slate-200"></div>
                <div>
                  <h4 className="font-bold text-slate-800">James T.</h4>
                  <p className="text-sm text-slate-500">Caregiver</p>
                </div>
              </div>
              <p className="text-slate-600 italic">"Managing my mother's medications was a full-time job before Scriptly. The Care Circle feature is a lifesaver."</p>
            </motion.div>
            <motion.div whileHover={{ y: -8 }} className="glass-card bg-white p-8 rounded-3xl transition-all">
              <div className="flex items-center gap-4 mb-4">
                <div className="w-12 h-12 rounded-full bg-slate-200"></div>
                <div>
                  <h4 className="font-bold text-slate-800">Dr. Emily R.</h4>
                  <p className="text-sm text-slate-500">Physician</p>
                </div>
              </div>
              <p className="text-slate-600 italic">"The prior auth automation saves my staff hours every week. We recommend Scriptly to all our patients with chronic conditions."</p>
            </motion.div>
          </div>
        </div>
      </section>
