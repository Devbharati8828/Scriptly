...
import {
  AutoRefillsIcon,
  NextDeliveryCalendarIcon,
  PriorAuthShieldIcon,
  CaregiverAlertsBellIcon,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-emerald-600">3 Scheduled</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-blue-600">Arriving Friday</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              <h3 className="font-bold text-slate-800">Prior Authorizations</h3>
              <p className="text-sm font-semibold text-indigo-600">2 In Progress</p>
            </div>
          </motion.div>
          ...
          >
            ...
            <div>
              ...
              <p className="text-sm font-semibold text-amber-600">1 New Alert</p>
            </div>
          </motion.div>
        </div>
