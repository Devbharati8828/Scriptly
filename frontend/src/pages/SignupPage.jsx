      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 bg-slate-50 relative">
        ...
        >
            ...
            <div className="pt-2">
              <Label className="flex items-start gap-3 cursor-pointer group">
                <div className="relative flex items-start pt-0.5">
                  ...
                  <div className="w-5 h-5 rounded border border-slate-300 bg-white peer-checked:bg-blue-600 peer-checked:border-blue-600 transition-colors" />
          ...
          <p className="mt-8 text-center text-slate-500 font-medium">
            ...
            <Link to="/login" className="text-blue-600 font-bold hover:text-blue-700">Sign in</Link>
          </p>
        </motion.div>
      </div>
    </div>
