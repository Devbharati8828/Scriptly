        ...
        <div className="flex items-center justify-between h-16 px-4 md:px-6">
          ...
          <div className="flex items-center gap-4">
            <Button
              variant="ghost"
              size="icon"
              className="md:hidden h-9 w-9 text-slate-500 hover:text-blue-600 hover:bg-blue-50"
              onClick={toggleSidebar}
              aria-label="Open sidebar"
            >
              <Menu className="h-5 w-5" />
            </Button>
            <h2 className="text-base md:text-lg font-semibold text-slate-700 tracking-tight">
