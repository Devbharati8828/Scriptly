...
export function CapsuleLogoIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g transform="rotate(-45 50 50)" filter="url(#shadow)">
        {/* Top half of capsule */}
        <path 
          d="M 32,50 L 32,32 A 18,18 0 0,1 68,32 L 68,50 Z" 
          fill="url(#capsuleBlue)" 
        />
        {/* Bottom half of capsule */}
        <path 
          d="M 68,50 L 68,68 A 18,18 0 0,1 32,68 L 32,50 Z" 
          fill="url(#capsuleOrange)" 
        />
        {/* White glossy sheen overlay */}
        <path 
...
export function AutoRefillsIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function NextDeliveryCalendarIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
      ...
      {/* Calendar Header */}
      <path 
        d="M 14,36 L 14,36 A 12,12 0 0,1 26,24 L 74,24 A 12,12 0 0,1 86,36 L 86,44 L 14,44 Z" 
        fill="url(#calHeader)" 
      />
      ...
      {/* Highlighted expected delivery day */}
...
export function PriorAuthShieldIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
...
export function CaregiverAlertsBellIcon({ className = "w-6 h-6" }: IconProps) {
  return (
    <svg className={className} viewBox="0 0 100 100" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
